// Filer object properties that starts with strIngredient and return the ones that area not null
...
const cocktailsLength = Object.entries(cocktails).filter(
	([key, value]) => key.startsWith('strIngredient') && value !== null
);

console.log(cocktailsLength);
